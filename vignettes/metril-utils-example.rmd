...
We will start by showing how the get false positive rate function works.  We will show that by using a cut-off threshold of .5 for the prediction probabilities
...
We will start by showing how the get false negative rate function works.  We will show that by using a cut-off threshold of .5 for the prediction probabilities
...
We will start by showing how the get true positive rate function works.  We will show that by using a cut-off threshold of .5 for the prediction probabilities
...
We will start by showing how the get true negative rate function works.  We will show that by using a cut-off threshold of .5 for the prediction probabilities
