...
#mvd: can you also give me a sample N to benchmark later numbers against
```
...
```{r}
#mvd: the number here is described as the negative predicted value in the confusion matrix above
...
```{r}
#the number here is shown as specificity in the confusion matrix above
